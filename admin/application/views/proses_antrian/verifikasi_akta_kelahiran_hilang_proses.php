            ...
            <div class="col-lg-12">
                ...
                <div id="file-upload">
                            ...
                            <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" id="surat_kelahiran" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <center>
                                            <img class="card-img" src="<?= base_url('file_upload/akta/akta_kelahiran_hilang/') . $data['file_surat_kelahiran']; ?>" alt="">
                                        </center>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" id="buku_nikah" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <center>
                                            <img class="card-img" src="<?= base_url('file_upload/akta/akta_kelahiran_hilang/') . $data['file_surat_nikah']; ?>" alt="">
                                        </center>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" id="ijazah" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <center>
                                            <img class="card-img" src="<?= base_url('file_upload/akta/akta_kelahiran_hilang/') . $data['file_ijazah']; ?>" alt="">
                                        </center>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" id="kk" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <center>
                                            <img class="card-img" src="<?= base_url('file_upload/akta/akta_kelahiran_hilang/') . $data['file_kartu_keluarga']; ?>" alt="">
                                        </center>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row mb-3 pl-3">
                            ...
                            <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" id="ktp_orangtua" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <center>
                                            <img class="card-img" src="<?= base_url('file_upload/akta/akta_kelahiran_hilang/') . $data['file_ktp_ortu']; ?>" alt="">
                                        </center>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-3">
                            <button class="btn btn-warning text-dark fixbutton" data-toggle="modal" data-target="#surhil">Surat Kehilangan <span class="fas fa-fw fa-file"></span></button>
                            <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" id="surhil" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Preview Surat Kehilangan</h4>
                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                        </div>
                                        <center>
                                            <img class="card-img" src="<?= base_url('file_upload/akta/akta_kelahiran_hilang/') . $data['file_surat_kehilangan']; ?>" alt="">
                                        </center>
                                    </div>
                                </div>
                            </div>

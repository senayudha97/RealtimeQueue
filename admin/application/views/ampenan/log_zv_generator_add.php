<div class="container-fluid">
    <div class="row">
        <div class="col-lg-11">
            <form action="<?= base_url('Log_ampenan_zv_generator/add'); ?>" method="POST">

                <h1 class="h3 mb-4 text-gray-800">Tambah Data <?= $title; ?></h1>
                <div id="hidden_field">
                    <input type="hidden" name="input[pk_zv_generator]" value="<?= 'ZG' . date('Ydhs'); ?>">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2 col-lg-4 col-md-4 mt-2">
                                <input type="text" class="form-control lzgsw1" id="input[suhu_winding_1]" name="input[suhu_winding_1]" placeholder="1">
                            </div>
                            <div class="col-sm-2 col-lg-3 col-md-3 mt-2">
                                <input type="text" class="form-control lzgsw2" id="input[suhu_winding_2]" name="input[suhu_winding_2]" placeholder="2">
                            </div>
                            <div class="col-sm-2 col-lg-3 col-md-3 mt-2">
                                <input type="text" class="form-control lzgsw3" id="input[suhu_winding_3]" name="input[suhu_winding_3]" placeholder="3">
                            </div>
                        </div>
                    </div>
                </div>

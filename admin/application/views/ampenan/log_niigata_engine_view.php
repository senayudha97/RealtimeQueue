<!-- <div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            ...
            <a class="btn btn-danger  my-4" href="<?= base_url() . 'Log_ampenan_niigata_engine/add'; ?>"> Input Data </a>
    ...
    <form action="<?= base_url('Log_ampenan_niigata_engine/report'); ?>" method="POST" target="_blank">
        <div class="row">
            <div class="col-sm-8">
                <div class="row">
                    <div class="col-sm-3">
                        <a href="<?= base_url() . 'Log_ampenan_niigata_engine/add'; ?>" class="btn btn-danger  mb-3">Data Baru</a>
                    </div>
                    <div class="col-sm-8">
                        <div class="row">
                            <div class="col-sm-6">

        ...
        <di class="row">
            <div class="col-lg-12">
                ...
                <div class="row mb-3 pl-3">
                    ...
                    <div class="col-3">
                        <button class="btn btn-warning text-dark fixbutton" data-toggle="modal" data-target="#kialama">kia Lama <span class="fas fa-fw fa-file"></span></button>
                    </div>
                </div>
...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" id="kk" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <center>
                <img class="card-img" src="<?= base_url('file_upload/kia/kia_hilang/') . $data['file_kk']; ?>" alt="">
            </center>
        </div>
    </div>
</div>
...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" id="aktakelahiran" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <center>
                <img class="card-img" src="<?= base_url('file_upload/kia/kia_hilang/') . $data['file_akta_kelahiran']; ?>" alt="">
            </center>
        </div>
    </div>
</div>

<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" id="kialama" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Preview kia Lama</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <center>
                <img class="card-img" src="<?= base_url('file_upload/kia/kia_hilang/') . $data['file_kia_lama']; ?>" alt="">
            </center>
        </div>
    </div>
</div>

  ...
  <form action="<?= base_url('log_paok_motong_checklist/report'); ?>" method="POST" target="_blank">
    <div class="row">
      <div class="col-sm-8">
        <div class="row">
          <div class="col-sm-3">
            <a href="<?= base_url() . 'log_paok_motong_checklist/add'; ?>" class="btn btn-danger  mb-3">Data Baru</a>
          </div>
          <div class="col-sm-8">
            <div class="row">
              <div class="col-sm-6">
        ...
        <tbody>
          ...
          <?php foreach ($data as $value) : ?>
            <tr>
              ...
              <td><?= $value['name']; ?></td>
              <td>
                <div class="btn btn-success btn-sm btn-sm ch" data-id="<?= $value['pk_checklist']; ?>" data-toggle="modal" data-target="#ch"><span class="fa fa-info-circle"> &nbsp;</span>Lihat Detail</div>
              </td>
              <td>
                <div class="btn btn-success btn-sm btn-sm ip" data-id="<?= $value['pk_checklist']; ?>" data-toggle="modal" data-target="#ip"><span class="fa fa-info-circle"> &nbsp;</span>Lihat Detail</div>
              </td>
              <td>
                <div class="btn btn-success btn-sm btn-sm gov" data-id="<?= $value['pk_checklist']; ?>" data-toggle="modal" data-target="#gov"><span class="fa fa-info-circle"> &nbsp;</span>Lihat Detail</div>
              </td>
              <td>
                <div class="btn btn-success btn-sm btn-sm sgb" data-id="<?= $value['pk_checklist']; ?>" data-toggle="modal" data-target="#sgb"><span class="fa fa-info-circle"> &nbsp;</span>Lihat Detail</div>
              </td>
              <td>
                <div class="btn btn-success btn-sm btn-sm bm" data-id="<?= $value['pk_checklist']; ?>" data-toggle="modal" data-target="#bm"><span class="fa fa-info-circle"> &nbsp;</span>Lihat Detail</div>
              </td>
              <td>
                <div class="btn btn-success btn-sm btn-sm gen" data-id="<?= $value['pk_checklist']; ?>" data-toggle="modal" data-target="#gen"><span class="fa fa-info-circle"> &nbsp;</span>Lihat Detail</div>
              </td>
              <td>
                <a href="<?= base_url('Log_paok_motong_checklist/edit/') . $value['pk_checklist']; ?>" class="btn btn-warning btn-sm btn-sm"><span class="fa fa-edit"></span></a>&nbsp;
                <a href="<?= base_url('log_paok_motong_checklist/delete/') . $value['pk_checklist']; ?>" class="btn btn-danger btn-sm btn-sm" onclick="javascript: return confirm('Anda yakin ingin menghapus?')"><span class="fa fa-trash"></span></a>
              </td>
            </tr>
            <?php $i++; ?>
          <?php endforeach; ?>

<div class="container-fluid">
    ...
    <form action="<?= base_url('shift_meeting/report'); ?>" method="POST" target="_blank">
        <div class="row">
            <div class="col-sm-8">
                <div class="row">
                    <div class="col-sm-2">
                        <a href="<?php echo (base_url('shift_meeting/add')) ?>" class="btn btn-danger   mb-3">Data Baru</a>
                    </div>
                    <div class="col-sm-8">
                        <div class="row">
                            <div class="col-sm-6">
            ...
            <table id="table_id" class="table table-bordered nowrap" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th class="tg-0lax">User Input</th>
                        <th class="tg-0lax">Anggota Regu Serah</th>
                        <th class="tg-0lax">Anggota Regu Terima</th>
                        <th class="tg-0lax">Peralatan Utama</th>
                ...
                <tbody>
                    ...
                    <?php foreach ($data as $value) : ?>
                        <tr>
                            ...
                            <td><?= $value['name']; ?></td>
                            <td>
                                <div class="btn btn-success btn-sm btn-sm anggota_serah" data-id="<?= $value['pk_shift_meeting']; ?>" data-toggle="modal" data-target="#anggota_serah"><span class="fa fa-info-circle"> &nbsp;</span>Lihat Detail</div></a>
                            </td>
                            <td>
                                <div class="btn btn-success btn-sm btn-sm anggota_terima" data-id="<?= $value['pk_shift_meeting']; ?>" data-toggle="modal" data-target="#anggota_terima"><span class="fa fa-info-circle"> &nbsp;</span>Lihat Detail</div></a>
                            </td>
                            <td>
                                <div class="btn btn-success btn-sm btn-sm peralatan_utama" data-id="<?= $value['pk_shift_meeting']; ?>" data-toggle="modal" data-target="#peralatan_utama"><span class="fa fa-info-circle"> &nbsp;</span>Lihat Detail</div></a>
                            </td>
                            <td>
                                <div class="btn btn-success btn-sm btn-sm peralatan_bantu" data-id="<?= $value['pk_shift_meeting']; ?>" data-toggle="modal" data-target="#peralatan_bantu"><span class="fa fa-info-circle"> &nbsp;</span>Lihat Detail</div></a>
                            </td>
                            <td>
                                <div class="btn btn-success btn-sm btn-sm keterangan" data-id="<?= $value['pk_shift_meeting']; ?>" data-toggle="modal" data-target="#keterangan"><span class="fa fa-info-circle"> &nbsp;</span>Lihat Detail</div></a>
                            </td>
                            <td>
                                <a href="<?= base_url('shift_meeting/edit/') . $value['pk_shift_meeting']; ?>" class="btn btn-warning btn-sm btn-sm"><span class="fa fa-edit"></span></a>&nbsp;
                                <a href="<?= base_url('shift_meeting/delete/') . $value['pk_shift_meeting']; ?>" class="btn btn-danger btn-sm btn-sm" onclick="javascript: return confirm('Anda yakin ingin menghapus?')"><span class="fa fa-trash"></span></a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.anggota_serah').on('click', function() {
                ...
                $.ajax({
                    url: "<?= base_url('shift_meeting/ajax'); ?>",
                    method: 'GET',
                    data: {
                        data: id
                    },

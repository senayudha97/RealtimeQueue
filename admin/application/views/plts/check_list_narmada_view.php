<div class="container-fluid">
    ...
    <form action="<?= base_url('Check_list_narmada/report'); ?>" method="POST" target="_blank">
        <div class="row">
            <div class="col-sm-8">
                <div class="row">
                    <div class="col-sm-2">
                        <a href="<?php echo (base_url('Check_list_narmada/add')) ?>" class="btn btn-danger   mb-3">Data Baru</a>
                    </div>
                    <div class="col-sm-8">
                        <div class="row">
                            <div class="col-sm-6">

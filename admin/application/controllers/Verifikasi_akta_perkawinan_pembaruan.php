...
class Verifikasi_akta_perkawinan_pembaruan extends Guide
{
    var $controller_dir = 'verifikasi_akta_perkawinan_pembaruan';
    ...
    public function index()
    {
        ...
        $data['data'] = $this->db->get('akta_perkawinan_pembaruan')->result_array();

        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('proses_antrian/verifikasi_akta_perkawinan_pembaruan_view', $data);
    ...
    public function proses($param = "")
    {
        ...
        $data['data'] = $this->db->get('akta_perkawinan_pembaruan')->row_array();

        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('proses_antrian/verifikasi_akta_perkawinan_pembaruan_proses', $data);
        $this->load->view('templates/footer');
    }

    ...
    <div class="row mb-3">
        <div class="col-sm-12">
            <select name="" class="form-control" id="move1">
                ...
                <option value="<?= base_url($this->page_dir . 'chart_ne'); ?>">Chart Ampenan</option>
            </select>
        </div>
    ...
    <div class="row mb-3">
        <div class="col-sm-12">
            <select name="" class="form-control" id="move">
                ...
                <option selected value="<?= base_url($this->page_dir . 'chart_perjamanMesin_Generator'); ?>">Perjaman Mesin Generator</option>
            ...
            <div class="row">
                <div id="graph" class="col-lg-12">
                    <div class="card">
                        ...
                        <form action="<?= base_url($this->page_dir . 'chart_perjamanMesin_generator'); ?>" method="POST">

    ...
    <div class="row mb-3">
        <div class="col-sm-12">
            <select name="" class="form-control" id="move">
                ...
                <option selected value="<?= base_url($this->page_dir . 'chart_perjamanMesin'); ?>">Perjaman Mesin</option>
            ...
            <div class="row">
                <div id="graph" class="col-lg-12">
                    <div class="card">
                        ...
                        <form action="<?= base_url($this->page_dir . 'chart_perjamanMesin'); ?>" method="POST">

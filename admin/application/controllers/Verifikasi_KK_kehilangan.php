...
class Verifikasi_KK_kehilangan extends Guide
{
    var $controller_dir = 'verifikasi_KK_kehilangan';
    ...
    public function index()
    {
        ...
        $data['data'] = $this->db->get('kk_kehilangan')->result_array();

        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('proses_antrian/verifikasi_KK_kehilangan_view', $data);
    ...
    public function proses($param = "")
    {
        ...
        $data['data'] = $this->db->get('kk_kehilangan')->row_array();

        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('proses_antrian/verifikasi_KK_kehilangan_proses', $data);
        $this->load->view('templates/footer');
    }

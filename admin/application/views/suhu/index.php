...
<div onload="startTime()" class="container-fluid mt-3 mb-5">
    <div class="row">
        <div class="col-lg-8">
            ...
            <form action="<?= base_url($this->page_dir . 'edit'); ?>" class="pl-3" method="POST">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <center>
                            <input type="submit" class="btn btn-danger btn-sm" style="margin: auto;" value="Simpan">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#temperature').change(function() {
                ...
                $.ajax({
                    url: "<?= base_url($this->page_dir . 'ajax'); ?>",
                    data: {

...
class Form_akta extends Guide
{
    ...
    public function index()
    {
        ...
        // $data['data'] = $this->db->get('akta_perubahan_data')->result_array();
    ...
    public function proses($param = "")
    {
        ...
        $data['data'] = $this->db->get('akta_perubahan_data')->row_array();
    ...
    public function verif($id = "")
    {
        ...
        if ($this->db->update('akta_perubahan_data')) {
            $this->db->where('id', $id);
            $user = $this->db->get('akta_perubahan_data')->row_array();
            $qrval = $user['nama'] . ',' . $user['email'] . ',' . $user['nohp'] . ',' . 'sa7d4c44a3ajads6ddd445ca0d1b65ca' . ',' . 'akta' . ',' . $id;

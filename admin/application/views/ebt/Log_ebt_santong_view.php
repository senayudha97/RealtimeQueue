<div class="container-fluid">
    ...
    <form action="<?= base_url('log_ebt_santong/report'); ?>" method="POST" target="_blank">
        <div class="row">
            <div class="col-sm-8">
                <div class="row">
                    <div class="col-sm-2">
                        <a href="<?php echo (base_url('log_ebt_santong/add')) ?>" class="btn btn-danger   mb-3">Data Baru</a>
                    </div>
                    <div class="col-sm-8">
                        <div class="row">
                            <div class="col-sm-6">
                ...
                <tbody>
                    ...
                    <?php foreach ($data as $value) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('log_ebt_santong/edit/') . $value['pk_log_tengah_jaman']; ?>" class="btn btn-warning btn-sm btn-sm"><span class="fa fa-edit"></span></a>&nbsp;
                                <a href="<?= base_url('log_ebt_santong/delete/') . $value['pk_log_tengah_jaman']; ?>" class="btn btn-danger btn-sm btn-sm" onclick="javascript: return confirm('Anda yakin ingin menghapus?')"><span class="fa fa-trash"></span></a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
...
<script>
    $(document).ready(function() {
        ...
        $('.voltage_generator').on('click', function() {
            ...
            $.ajax({
                url: "<?= base_url('log_ebt_santong/ajax'); ?>",
                method: 'GET',
                data: {
                    data: id
                },

<!-- <div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            ...
            <a class="btn btn-danger  my-4" href="<?= base_url() . 'log_ampenan_zav_generator/add'; ?>"> Input Data </a>
            ...
            <table class="table table-hover table-responsive table-bordered text-center">
                ...
                <?php for ($i = 1; $i <= 5; $i++) : ?>
                    <tr>
                        ...
                        <td scope="row">15</td>
                        <td>
                            <a href="<?php echo (base_url('log_ampenan_zav_generator/edit')) ?>" class="btn btn-warning btn-sm"><span class="fa fa-edit"></span></a>&nbsp;
                        </td>
                        <td>
                            <a href="<?php echo (base_url('log_ampenan_zav_generator/detail')) ?>" class="btn btn-success btn-sm"><span class=<i class="fas fa-info-circle"></i>></span></a>&nbsp;
                        </td>
                        <td>
...
<div class="container-fluid">
    ...
    <form action="<?= base_url('Log_ampenan_zav_generator/report'); ?>" method="POST" target="_blank">
        <div class="row">
            <div class="col-sm-8">
                <div class="row">
                    <div class="col-sm-2">
                        <a href="<?php echo (base_url('Log_ampenan_zav_generator/add')) ?>" class="btn btn-danger   mb-3">Data Baru</a>
                    </div>
                    <div class="col-sm-8">
                        <div class="row">
                            <div class="col-sm-6">
                ...
                <tbody>
                    ...
                    <?php foreach ($data as $value) :  ?>
                        <tr>
                            ...
                            <td><?= $value['waktu']; ?></td>
                            <td>
                                <div class="btn btn-success btn-sm generator" data-id="<?= $value['pk_zav_generator']; ?>" data-toggle="modal" data-target="#generator"><span class="fa fa-info-circle"> &nbsp;</span>Lihat Detaill</div></a>
                            </td>
                            <td><?= $value['bearing']; ?></td>
                            <td>
                                <div class="btn btn-success btn-sm sikap_kwh_meter" data-id="<?= $value['pk_zav_generator']; ?>" data-toggle="modal" data-target="#sikap_kwh_meter"><span class="fa fa-info-circle"> &nbsp;</span>Lihat Detaill</div></a>
                            </td>
                            <td>
                                <div class="btn btn-success btn-sm arus" data-id="<?= $value['pk_zav_generator']; ?>" data-toggle="modal" data-target="#arus"><span class="fa fa-info-circle"> &nbsp;</span>Lihat Detaill</div></a>
                            </td>
                            <td><?= $value['level_becomes']; ?></td>
                            <td><?= $value['waktu_input']; ?></td>
                            <td><?= $value['operator']; ?></td>
                            <td>
                                <a href="<?php echo (base_url('Log_ampenan_zav_generator/edit/')) . $value['pk_zav_generator'] ?>" class="btn btn-warning btn-sm "><span class="fa fa-edit"></span></a>&nbsp;
                                <a href="<?= base_url('Log_ampenan_zav_generator/delete/') . $value['pk_zav_generator']; ?>" class="btn btn-danger btn-sm btn-sm" onclick="javascript: return confirm('Anda yakin ingin menghapus?')"><span class="fa fa-trash"></span></a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
...
<script>
    $(document).ready(function() {
        ...
        $('.generator').on('click', function() {
            ...
            $.ajax({
                url: "<?= base_url('Log_ampenan_zav_generator/ajax'); ?>",
                method: 'GET',
                data: {
                    data: id
                },

    ...
    <div class="row mb-3">
        <div class="col-sm-12">
            <select name="" class="form-control" id="move">
                ...
                <option value="<?= base_url($this->page_dir . 'chart_niigata_generator'); ?>">Niigata Generator</option>
                ...
                <option value="<?= base_url($this->page_dir . 'chart_pg'); ?>" selected>Pielstick Generator</option>
            ...
            <div class="row">
                <div id="graph" class="col-lg-12">
                    <div class="card">
                        ...
                        <form action="<?= base_url($this->page_dir . 'chart_pg'); ?>" method="POST">

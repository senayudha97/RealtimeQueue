...
class Verifikasi_akta_kelahiran_baru extends Guide
{
    var $controller_dir = 'verifikasi_akta_kelahiran_baru';
    ...
    public function index()
    {
        ...
        $this->load->view('proses_antrian/verifikasi_akta_kelahiran_baru_view', $data);
    ...
    public function proses($param = "")
    {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('proses_antrian/verifikasi_akta_kelahiran_baru_proses', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function verif($id = "")
    {
        ...
        if ($this->db->update('akta_kelahiran_baru')) {
            ...
            $qrval = $user['nama'] . ',' . $user['email'] . ',' . $user['nohp'] . ',' . 'sa7d4c44a3ajads6ddd445ca0d1b65ca' . ',' . 'Akta' . ',' . $id . ',' . 'akta_kelahiran_baru';


            $this->sendEmail(['email' => $user['email'], 'message' => "Pengajuan antrian Akta Kelahiran Baru anda telah diverifikasi oleh petugas, Simpan QR Code lalu datang ke kantor Dinas Kependudukan dan Pencatatan Sipil Kabupaten Mojokerto untuk scan dan mendapat antrian anda.", 'qrval' => $qrval, 'istolak' => false]);

...
class Admin_pm extends Guide
{
    var $page_dir = 'admin_pm/';
    ...
    public function niigata_generator()
    {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('admin_pm/index', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function chart_bebanpenyulang()
    {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('admin_pm/chart_bebanpenyulang', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function chart_perjamanMesin()
    {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('admin_pm/chart_perjamanMesin', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function chart_perjamanMesin_generator()
    {
            ...
            if (!empty($akhir)) {
                ...
                while (strtotime($awal) <= strtotime($akhir)) {
                    ...
                    if ($count['total'] == 24) {
                        ...
                        exit;
                        $this->flash_fail("Pada tanggal " . content_date($awal) . " data belum berjumlah 24, Proses tidak dapat di selesaikan.");
                        redirect('admin_pm/chart_perjamanMesin_generator');
                        exit;
                    }
                }
                $data['arr_value'] = $arr_get_value;
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('admin_pm/chart_perjamanMesin_generator', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function chart_boosterModule()
    {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('admin_pm/chart_boosterModule', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function chart_hrto()
    {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('admin_pm/chart_hrto', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function chart_pab()
    {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('admin_pm/chart_pab', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function chart_mfo()
    {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('admin_pm/chart_mfo', $data);
        $this->load->view('templates/footer');
    }

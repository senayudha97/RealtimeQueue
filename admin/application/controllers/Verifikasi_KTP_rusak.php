...
class verifikasi_KTP_rusak extends Guide
{
    var $controller_dir = 'verifikasi_KTP_rusak';
    ...
    public function index()
    {
        ...
        $data['data'] = $this->db->get('ktp_rusak')->result_array();

        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('proses_antrian/verifikasi_KTP_rusak_view', $data);
    ...
    public function proses($param = "")
    {
        ...
        $data['data'] = $this->db->get('ktp_rusak')->row_array();

        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('proses_antrian/verifikasi_KTP_rusak_proses', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function verif($id = "")
    {
        ...
        if ($this->db->update('ktp_rusak')) {
            $this->db->where('id', $id);
            $user = $this->db->get('ktp_rusak')->row_array();

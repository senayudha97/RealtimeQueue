        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row mb-3 pl-3">
                    <div class="col-3">
                        <button class="btn btn-warning text-dark fixbutton" data-toggle="modal" data-target="#kklama">KK Lama yang Rusak <span class="fas fa-fw fa-file"></span></button>
                    </div>
                ...
                <div class="row mb-3 pl-3">
                    <div class="col-3">
                        <button class="btn btn-warning text-dark " data-toggle="modal" data-target="#suratnikah">Surat Nikah / Akta Cerai / Akta Kematian Asli <span class="fas fa-fw fa-file"></span></button>
                    </div>
        ...
        <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" id="formisian" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <center>
                        <img class="card-img" src="<?= base_url('file_upload/kk/kk_rusak/') . $data['file_form']; ?>" alt="">
                    </center>
                </div>
            </div>
        </div>
        <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" id="kklama" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">

...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <h4 class="small font-weight-bold mt-3">Antrian KIA Pemula</h4>
            <div class="row">
            ...
            <h4 class="small font-weight-bold mt-3">Antrian KIA Hilang</h4>
            <div class="row">
            ...
            <h4 class="small font-weight-bold mt-3">Antrian KIA Rusak</h4>
            <div class="row">
                    ...
                    <div class="container">
                        ...
                        <?php else : ?>
                            <div class="embed-responsive embed-responsive-16by9">
                                <iframe class="embed-responsive-item" src="<?= base_url('file_upload/form_pengajuan/kia/' . $data[0]['file']); ?>"></iframe>
                            </div> <?php endif; ?>
                    </div>
                </center>
            </div>
    ...
    <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" id="pemulaupload" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Upload Form KIA Pemula </h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <center>
                    <div class="container mt-5 mb-5">
                        <form method="POST" enctype="multipart/form-data" action="<?= base_url($this->controller_dir . '/edit'); ?>">
                            ...
                            <input type="file" name="kia_pemula" required class="form-control">
            ...
            <div class="modal-content">
                ...
                <center>
                    <div class="container">
                        ...
                        <?php else : ?>
                            <div class="embed-responsive embed-responsive-16by9">
                                <iframe style="height: 1000px;" class="embed-responsive-item" allowfullscreen src="<?= base_url('file_upload/form_pengajuan/kia/' . $data[1]['file']); ?>"></iframe>
                            </div>
                        <?php endif; ?>
                    </div>
                </center>
    ...
    <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" id="hilangupload" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Upload Form KIA Hilang </h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <center>
                    <div class="container mt-5 mb-5">
                        <form method="POST" enctype="multipart/form-data" action="<?= base_url($this->controller_dir . '/edit'); ?>">
                            ...
                            <input type="file" name="kia_hilang" required class="form-control">
                            <button type="submit" class="btn btn-block btn-success mt-3">UPLOAD <span class="fas fa-fw fa-upload"></span></button>
                        </form>
                    </div>
                </center>
            ...
            <div class="modal-content">
                ...
                <center>
                    <div class="container">
                        ...
                        <?php else : ?>
                            <div class="embed-responsive embed-responsive-16by9">
                                <iframe style="height: 1000px;" class="embed-responsive-item" allowfullscreen src="<?= base_url('file_upload/form_pengajuan/kia/' . $data[2]['file']); ?>"></iframe>
                            </div>
                        <?php endif; ?>
                    </div>
                </center>
    ...
    <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" id="rusakupload" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Upload Form KIA Rusak </h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <center>
                    <div class="container mt-5 mb-5">
                        <form method="POST" enctype="multipart/form-data" action="<?= base_url($this->controller_dir . '/edit'); ?>">
                            ...
                            <input type="file" name="kia_rusak" required class="form-control">
                            <button type="submit" class="btn btn-block btn-success mt-3">UPLOAD <span class="fas fa-fw fa-upload"></span></button>
                        </form>
                    </div>
                </center>
